...
class _MyAppState extends State<MyAppQR> {
  ...
  void registrarAsistencia() async{
    ...
    var api= await Provider.of<AsistenciaxApi>(context, listen: false).getAsistenciapa(TokenUtil.TOKEN);
    print(api);
    print(modelA.id);
    AsistenciaxModelo mp = new AsistenciaxModelo.unlaunched();
    mp.actividadId=modelA.id;
    mp.id=0;
    ...
    var apix = await Provider.of<AsistenciaxApi>(
        context,
        listen: false)
