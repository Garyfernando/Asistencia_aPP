...
import 'package:frontend_quimir/apis/usuario_api.dart';
import 'package:frontend_quimir/comp/Button.dart';
import 'package:frontend_quimir/drawer/navigation_home_screen.dart';


import 'package:frontend_quimir/modelo/UsuarioModelo.dart';
import 'package:frontend_quimir/util/TokenUtil.dart';

import 'package:flutter/material.dart';
import 'package:frontend_quimir/login/sign_in.dart';
            ...
            children: <Widget>[
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: "Password",
                  labelText: "Password",
                  helperText:"La contraseña debe contener un carácter especial ok",
                  helperStyle:TextStyle(color:Colors.green),
      ...
      onPressed: () async {
        ...
        signInWithGoogle().then((result) async{
          if (result != null)  {
            ...
            if(!TokenUtil.localx){
              final api=Provider.of<UsuarioApi>(context,listen: false);
              final user=UsuarioModelo.login("fernando@gmail.com", "Ga12345*");
              api.login(user).then((value){
                tokenx="Bearer "+value.token;
                prefs.setString("token", tokenx);
                TokenUtil.TOKEN=tokenx;
